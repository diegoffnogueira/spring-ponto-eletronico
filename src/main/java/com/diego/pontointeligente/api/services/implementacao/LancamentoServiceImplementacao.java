...
import com.diego.pontointeligente.api.services.LancamentoService;
...
public class LancamentoServiceImplementacao implements LancamentoService{
    ...
    private static final Logger log = LoggerFactory.getLogger(LancamentoServiceImplementacao.class);
    ...
    public void remover(Long id) {
        log.info("Removendo um lançamento pelo ID {}", id);
